...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="text-center mt-3">
                        <a class="btn btn-link" href="<?php echo e(route('login')); ?>">Already have an account? Login here!</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\joshu\Documents\Project WebProg\Laravel 11\resources\views/auth/register.blade.php ENDPATH**/ ?>